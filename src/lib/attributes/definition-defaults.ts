...
export function defaultAttributeDefinitions(): AttributeEventDefinitions {
  return {
    ...
    types: [
      { typeKey: "eyes", categoryKey: "physical_attribute", typeLabel: "Eyes", detailLabel: "Eye Color / Detail", dateMode: "single", askEndDate: false, sortOrder: 10, isEnabled: true, kind: "descriptor" },
      { typeKey: "height", categoryKey: "physical_attribute", typeLabel: "Height", detailLabel: "Height", dateMode: "single", askEndDate: false, sortOrder: 20, isEnabled: true, kind: "descriptor" },
      { typeKey: "blood_type", categoryKey: "physical_attribute", typeLabel: "Blood Type", detailLabel: "Blood Type", dateMode: "single", askEndDate: false, sortOrder: 30, isEnabled: true, kind: "descriptor" },
      { typeKey: "allergy", categoryKey: "physical_attribute", typeLabel: "Allergy", detailLabel: "Allergy Detail", dateMode: "single", askEndDate: false, sortOrder: 40, isEnabled: true, kind: "descriptor" },
      { typeKey: "other", categoryKey: "physical_attribute", typeLabel: "Other", detailLabel: "Attribute Detail", dateMode: "single", askEndDate: false, sortOrder: 50, isEnabled: true, kind: "descriptor" },
