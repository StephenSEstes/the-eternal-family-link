...
function buildInstructions(input: {
  ...
  return [
    ...
    "Return a maximum of 3 story proposals unless there are clearly more than 3 fully independent life events with different time periods.",
    ...
    "Do not create more than one story per section unless the section clearly contains multiple unrelated events.",
    "Within a single section, do not split into multiple stories unless there is a clear shift in time period AND narrative purpose.",
    "Do not create multiple stories from descriptive expansion (details, examples, or supporting context).",
    ...
    "RELEVANCE FILTER FOR STORIES:",
    "Do not create separate stories for background statistics, extended explanations, or supporting context.",
    "Each story must represent a distinct lived experience of the subject, not general context.",
    "STORY PRIORITIZATION:",
    "Prefer broader, cohesive life context stories over multiple narrow fragments.",
    "Merge highly related content into a single story when it represents one continuous life setting.",
    ...
    "If an exact date is not provided, infer an approximate date when strong contextual signals exist.",
    "DATE INFERENCE RULES:",
    "Use explicitly stated anchor dates (for example birth year, dated events) to estimate timing of stories.",
    "If a story describes early childhood, estimate within 0-5 years after birth.",
    "If a story references 'as a baby' or 'first home', anchor to birth year.",
    "If a story references a known historical period (for example Great Depression), align estimate within that timeframe.",
    "Prefer year-level estimates unless a month is explicitly stated.",
    "Set attributeDate to the estimated year (for example 1935), set dateIsEstimated=true, and set estimatedTo=year.",
